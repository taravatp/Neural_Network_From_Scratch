...
As you can see in the following picture, in the american sign language each hand gesture is associated with a letter. Our task is to implement a model that learn what letter each hand gesture represents (multi-class classification task).
